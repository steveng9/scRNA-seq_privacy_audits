...
from attacks.baselines.sc_baseline import DOMIASSingleCellBaselineModels
...
def create_config(config_path):
    with open(config_path) as f:
        ...
        cfg.experiment_setting_path = os.path.join(cfg.dir_list[_ENV].data, cfg.dataset_name, cfg.split_name)
