# adapted https://github.com/sdv-dev/CTGAN/blob/main/ctgan/data_transformer.py
import warnings
...
class DataTransformer(object):
    ...
    def _transform_continuous_standard(self, column_transform_info, raw_column_data):
        """standard continuous column by removing the mean and scaling to unit variance."""
